...
export const assignLead = async (leadId, staffObj, assignedBy) => {
    try {
        ...
        const isConverted = hasAdmission || ['CONVERTED', 'TOKEN_PAID', 'ADMISSION_TAKEN', 'CLOSED', 'LOST', 'REJECTED', 'REFUNDED'].includes(currentStatus);
        ...
        if (isConverted) {
            newStatus = ['TOKEN_PAID', 'ADMISSION_TAKEN', 'CLOSED', 'LOST', 'REJECTED', 'REFUNDED'].includes(currentStatus) 
                ? currentStatus 
                : "CONVERTED";
        }
